...
function emailBody($house){
	...
	$body .= "<td>MLS: ".$house['ml_num']." &nbsp;&nbsp;".$house['br']."??".$house['bath_tot']."??</td></tr><tr><td>";
	$body .= "<p>??????".$house['addr'].",".$house['municipality']."</p></td></tr><tr>";
	$body .= "<td>??????".$house['lp_dol']."</td>";
	$body .= "	</tr>	</tbody>	</table>	</td>	</tr>	</tbody>	</table>	<h2><a href=".$urlp.$house['ml_num'].">????????&nbsp;	</a></h2>	<p>&nbsp;	</p>";
...
function emailSubject($house){
	...
	$s= $house['municipality'].":".$house['addr']." ".$house['br']."??".$house['bath_tot']."?? - ????:".$house['lp_dol'];
