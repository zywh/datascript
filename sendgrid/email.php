...
$mail->personalization[0]->addSubstitution("-city-", $house['municipality']);
$mail->personalization[0]->addSubstitution("-br-", $house['br']);
$mail->personalization[0]->addSubstitution("-bath-", $house['bath_tot']);
