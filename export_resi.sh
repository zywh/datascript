...
exportresi="
select  
concat('mlspic/crea/Ontario/Photo',resi.ml_num,'/Photo',resi.ml_num,'-1.jpeg') ,
concat('mlspic/crea/Ontario/Photo',resi.ml_num,'/Photo',resi.ml_num,'-1.jpeg,mlspic/crea/Ontario/Photo',resi.ml_num,'/Photo',resi.ml_num,'-2.jpeg,mlspic/crea/Ontario/Photo',resi.ml_num,'/Photo',resi.ml_num,'-3.jpeg') ,
lat ,
lon ,
addr	,
a_c	,
...
#sudo gzip /tmp/resi.csv


#echo "SCP CSV to Ali Server...."
#ssh root@alius rm  /tmp/resi.csv
#scp /tmp/resi.csv.gz root@ali:/tmp/resi.csv.gz
#sleep 10
#echo "Unzip CSV File"
#ssh root@alius gzip -d /tmp/resi.csv.gz


#Load Data into maplecity table

#echo "Load SQL into Maplecity DB"
#ssh root@ali /root/script/loadmls.sh
...
#Empty h_housetmp table
#sql="delete from h_housetmp;"
#Create tmp table for loading
