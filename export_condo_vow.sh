...
'VOW',
maint,
concat('mlspic/crea/Ontario/Photo',vowcondo.ml_num,'/Photo',vowcondo.ml_num,'-1.jpeg') ,
concat('mlspic/crea/Ontario/Photo',vowcondo.ml_num,'/Photo',vowcondo.ml_num,'-1.jpeg,mlspic/crea/Ontario/Photo',vowcondo.ml_num,'/Photo',vowcondo.ml_num,'-2.jpeg,mlspic/crea/Ontario/Photo',vowcondo.ml_num,'/Photo',vowcondo.ml_num,'-3.jpeg') ,
lat ,
lon ,
addr	,
a_c	,
...
tour_url	,
bath_tot	
FROM vowcondo,location
WHERE vowcondo.county ='Ontario' AND vowcondo.ml_num REGEXP '[a-z][0-9].*' AND vowcondo.ml_num = location.ml_num 
