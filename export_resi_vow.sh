...
tour_url	,
bath_tot	
FROM vowresi,location
WHERE vowresi.county ='Ontario' AND vowresi.ml_num REGEXP '[a-z][0-9].*' AND vowresi.ml_num = location.ml_num 
